...
const serve = new server_1.default(3900);
serve.addNewType(`
type Query {
...
serve.addNewResolver({
    ...
    Mutation: {
        newGame: (_, args, { pubsub }) => {
            ...
            const tictac = new game_1.Game({ human: game.human, ai: game.ai });
            tictac.setScores();
        ...
        newMove: (_, args, { pubsub }) => {
            ...
            const tictac = new game_1.Game({ human: gameData.human, ai: gameData.ai });
